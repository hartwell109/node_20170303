var crt310 = require('../../devices/CRT_310.js')
var ref = require('ref');
 ...
 */
var commOpen = function (callback) {
...
//  *   如果函数调用失败，返回值不为 0
//  */
var reset = function (handle, callback) {
    var eject = 0x1;
    console.log('CRT310_Reset=' + crt310.CRT310_Reset(handle, eject))
}
//
// /**
//  * 获取卡机状态
...
//  *   如果函数调用失败，返回值不为 0。
//  */
var cardSetting = function (handle, callback) {
    var cardIn = 0x3;
...
//  *  0=成功
//  */
// // console.log('CommClose=' + device.CommClose(
